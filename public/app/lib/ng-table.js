 ...
 *  WARNING !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 *
 *  This file has been manually modified from it's original version so do NOT simply replace it!
 *
 *
 *
 */
...
(function(angular, factory) {
                    ...
                    return function (scope, element, attrs) {
                        ...
                        angular.forEach(columns, function (column) {
                            ...
                            return def.promise.then(function (data) {
                                ...
                                data.unshift({
                                    title: 'All', // manually changed from '-' to 'All'
                                    id: ''
                                });
                                column.data = data;
                            });
    ...
    angular.module('ngTable').run(['$templateCache', function ($templateCache) {
        ...
        $templateCache.put('ng-table/filters/date.html', '<div ar-simple-datepicker ng-model="params.filter()[name]" name="{{column.filterName}}" ng-required="false"/>');
        ...
        $templateCache.put('ng-table/pager.html', '<div class="row"><div class="col-md-12"><div class="ng-cloak ng-table-pager pull-right"><ul class="mar-pagination ng-table-pagination"><li ng-class="{\'disabled\': !page.active}" ng-repeat="page in pages" ng-switch="page.type"><a ng-switch-when="prev" ng-click="params.page(page.number)" href="" class="paging-asset">&laquo;</a><a ng-switch-when="first" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a><a ng-switch-when="page" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a><a ng-switch-when="more" ng-click="params.page(page.number)" href="" class="paging-asset">&#8230;</a><a ng-switch-when="last" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a><a ng-switch-when="next" ng-click="params.page(page.number)" href="" class="paging-asset">&raquo;</a></li></ul></div><div class="ng-table-index pull-right">Displaying customers {{params.total() > 0 ? params.page()*params.count()-params.count()+1 : 0}}-{{((params.page()*params.count() < params.total())? params.page()*params.count() : params.total())}} of {{params.total()}}</div></div></div>');
