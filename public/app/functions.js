    ...
    var settings =  '<a id="settings" href="#changeSkin" data-toggle="modal">' +
			...
			'<div class="modal-dialog modal-lg">' +
				...
				'<div class="modal-body">' +
					...
					'</a>' +
                    '<a  data-skin="skin-blur-pale"class="col-sm-2 col-xs-4" href="">' +
                        '<img src="img/skins/skin-pale.jpg" alt="">' +
                    '</a>' +
                    '<a  data-skin="skin-blur-blue2"class="col-sm-2 col-xs-4" href="">' +
                        '<img src="img/skins/skin-blue2.jpg" alt="">' +
                    '</a>' +
                    '<a  data-skin="skin-blur-multi"class="col-sm-2 col-xs-4" href="">' +
                        '<img src="img/skins/skin-multi.jpg" alt="">' +
                    '</a>' +
